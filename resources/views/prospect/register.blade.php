                        ...
                        <form action="{{route('prospect.register.store')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="country" list="lstCountry" value="{{ old('country') }}">
                                ...
                                <div class="form-group col-12 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="estate" list="lstStates" value="{{ old('estate') }}">
                                ...
                                <div class="form-group col-12 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="city" list="lstCities" value="{{ old('city') }}">
                                ...
                                <div class="form-group col-12 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="commercial_business" list="lstComercialBusiness" value="{{ old('commercial_business') }}">
